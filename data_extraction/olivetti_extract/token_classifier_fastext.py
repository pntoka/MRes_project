...
class TokenClassifier(object):
    def __init__(self, nlp=None, seq_maxlen=100, fpath='/home/ptoka/extract/materials-synthesis-generative-models/data/ner_annotations_split.json'):
        if nlp is None:
    ...
    def save(self, filepath='/home/ptoka/extract/materials-synthesis-generative-models/token_classifier_fasttext.model'):
        self.model.save(filepath)

    def load(self, filepath='/home/ptoka/extract/materials-synthesis-generative-models/token_classifier_fasttext.model'):
    ...
    def _load_embeddings(self, ft_fpath='/home/ptoka/extract/materials-synthesis-generative-models/fasttext_embeddings-MINIFIED.model'):
